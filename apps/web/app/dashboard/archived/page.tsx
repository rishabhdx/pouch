...
import { FavoriteBookmarks } from "@/components/bookmarks/favorite";
...
import { ArchivedBookmarks } from "@/components/bookmarks/archived";
  ...
  return (
    <div className="h-full w-full py-4 px-4 lg:px-6 overflow-hidden flex flex-col gap-4">
      ...
      <Suspense fallback={<BookmarksLoadingState />}>
        <ArchivedBookmarks userId={session.user.id} />
      </Suspense>
    </div>
  );
}
